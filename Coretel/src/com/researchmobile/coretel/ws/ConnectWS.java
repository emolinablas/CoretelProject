...
public class ConnectWS {
	...
	public JSONObject ComunidadesTodas(String url) {
		...
		try {
			URL urlCon = new URL("http", IP_SERVER, PUERTO, "/WS/" + url);
			HttpURLConnection urlConnection = (HttpURLConnection) urlCon.openConnection();
			System.out.println("comunidades todas - url = " + urlCon);
			InputStream inputStream = urlConnection.getInputStream();
	...
	public JSONObject solicitarComunidad(String url) {
		JSONObject jsonObject = null;
		try {
			URL urlCon = new URL("http", IP_SERVER, PUERTO, "/WS/" + url);
			HttpURLConnection urlConnection = (HttpURLConnection) urlCon.openConnection();
			System.out.println("envia solicitud - url = " + urlCon);
			InputStream inputStream = urlConnection.getInputStream();
	...
	public JSONObject eliminaMiembro(String url) {
		JSONObject jsonObject = null;
		try {
			URL urlCon = new URL("http", IP_SERVER, PUERTO, "/WS/" + url);
			HttpURLConnection urlConnection = (HttpURLConnection) urlCon.openConnection();
			System.out.println("Elimina Miembro - url = " + urlCon);
			InputStream inputStream = urlConnection.getInputStream();
	...
	public JSONObject recuperarClave(String finalURL) {
		JSONObject jsonObject = null;
		try {
			URL urlCon = new URL("http", IP_SERVER, PUERTO, "/WS/" + finalURL);
			HttpURLConnection urlConnection = (HttpURLConnection) urlCon.openConnection();
